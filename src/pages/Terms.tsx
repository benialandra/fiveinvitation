        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-white/70 space-y-8">
          <section>
            <h2 className="text-2xl font-serif text-gray-900 dark:text-white mb-4">
              {lang === 'id' ? '1. Pihak yang Terlibat & Layanan Kami' : '1. Parties Involved & Our Services'}
            </h2>
            <p>
              {lang === 'id' 
          ...
          <section>
            <h2 className="text-2xl font-serif text-gray-900 dark:text-white mb-4">
              {lang === 'id' ? '2. Pembuatan Undangan & Akun' : '2. Invitation Creation & Account'}
            </h2>
            <p>
              {lang === 'id'
          ...
          <section>
            <h2 className="text-2xl font-serif text-gray-900 dark:text-white mb-4">
              {lang === 'id' ? '3. Pembayaran & Kebijakan Pengembalian Dana' : '3. Payment & Refund Policy'}
            </h2>
            <p>
              {lang === 'id'
          ...
          <section>
            <h2 className="text-2xl font-serif text-gray-900 dark:text-white mb-4">
              {lang === 'id' ? '5. Pembatasan Tanggung Jawab' : '5. Limitation of Liability'}
            </h2>
            <p>
              {lang === 'id'
          ...
          <section>
            <h2 className="text-2xl font-serif text-gray-900 dark:text-white mb-4">
              {lang === 'id' ? '6. Perubahan Ketentuan' : '6. Changes to Terms'}
            </h2>
            <p>
              {lang === 'id'
