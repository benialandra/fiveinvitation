...
const FallingLeaves = () => {
  ...
  useEffect(() => {
    ...
    const leafColors = [
      'rgba(212, 175, 55, 0.65)',  // Warm Gold
      'rgba(205, 127, 50, 0.6)',   // Copper Bronze
      'rgba(184, 115, 51, 0.65)',  // Sienna Brown
      'rgba(194, 65, 12, 0.55)',   // Rust Orange
      'rgba(146, 64, 14, 0.6)',    // Deep Auburn
      'rgba(245, 158, 11, 0.6)'    // Bright Amber
    ];
    ...
    const drawLeaf = (ctx: CanvasRenderingContext2D, x: number, y: number, size: number, rotation: number, color: string) => {
      ctx.save();
      ctx.translate(x, y);
      ctx.rotate(rotation);
      ctx.fillStyle = color;
      
      // Draw organic bezier leaf shape
      ctx.beginPath();
      ctx.moveTo(0, -size / 2);
...
export default function AutumnSunset({ data, guestName, lang = 'id' }: ThemeProps) {
  ...
  const groomImage = "https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=600&auto=format&fit=crop";
  const brideImage = "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=600&auto=format&fit=crop";
  ...
  const gallery4 = "https://images.unsplash.com/photo-1532712938310-34cb3982ef74?q=80&w=600&auto=format&fit=crop";
  ...
  const [comments, setComments] = useState([
    { id: 1, name: "Dr. Adrian Maulana", message: `Selamat menempuh hidup baru ${groomName} & ${brideName}! Semoga menjadi keluarga sakinah, mawaddah, warahmah. Sangat menyukai nuansa undangan autumn ini, sangat cinematic!`, date: "2 jam yang lalu" },
    { id: 2, name: "Clara & Kevin", message: "Warmest congratulations on your beautiful wedding! Wishing you both a lifetime of absolute happiness, love, and wonderful memories together in this new chapter.", date: "5 jam yang lalu" },
    { id: 3, name: "Ibu Indah Lestari", message: "Barakallahu lakum wa baraka 'alaikum wa jama'a bainakuma fii khair. Turut berbahagia untuk kedua keluarga besar, semoga dilancarkan segala urusan di hari H.", date: "1 hari yang lalu" }
  ]);
  ...
  useEffect(() => {
    ...
    link.href = 'https://fonts.googleapis.com/css2?family=Cinzel:wght@400;500;600;700&family=Playfair+Display:ital,wght@0,400..900;1,400..900&family=Plus+Jakarta+Sans:wght@300;400;500;600;700&display=swap';
    link.rel = 'stylesheet';
  ...
  return (
    <div className="bg-[#120804] text-[#faf6f0] selection:bg-[#df9f28]/30 selection:text-[#df9f28] overflow-x-hidden relative min-h-screen" style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.button
            ...
            onClick={toggleAudio}
            className="fixed bottom-6 right-6 z-50 p-4 rounded-full bg-[#3d2417]/80 hover:bg-[#523220] text-[#df9f28] border border-[#df9f28]/40 shadow-[0_0_20px_rgba(223,159,40,0.2)] backdrop-blur-md transition-all duration-300 flex items-center justify-center cursor-pointer"
      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-50 flex flex-col items-center justify-center text-center px-6 overflow-hidden bg-[#180d07]"
          >
            ...
            <div className="relative z-10 max-w-xl mx-auto flex flex-col items-center justify-center h-full pt-10">
              ...
              <motion.div
                ...
                className="mb-4 text-[#df9f28]"
              >
                <Heart size={32} className="stroke-1 fill-[#df9f28]/10" />
              </motion.div>
              ...
              <motion.p 
                ...
                className="tracking-[0.35em] text-[#d5c2b0]/90 text-xs md:text-sm uppercase font-semibold mb-6"
              >
                {t.title}
              </motion.p>
              ...
              >
                ...
                <div className="absolute inset-0 rounded-full border-2 border-dashed border-[#df9f28]/30 animate-[spin_100s_linear_infinite]" />
              ...
              >
                {brideName} <span className="text-[#df9f28] font-serif font-light italic">&amp;</span> {groomName}
              </motion.h1>
              ...
              <motion.p
                ...
                className="text-[#d5c2b0]/70 font-serif italic text-sm md:text-base mb-8 tracking-wider"
              >
              ...
              {guestName && (
                <motion.div 
                  ...
                  className="mb-10 px-8 py-5 rounded-2xl bg-[#2e1f16]/75 border border-[#df9f28]/25 backdrop-blur-md shadow-[0_8px_32px_rgba(0,0,0,0.5)] w-full max-w-sm"
                >
                  <p className="text-[10px] tracking-[0.25em] uppercase text-[#d5c2b0]/60 mb-2 font-medium">{t.dear}</p>
                  <p className="text-xl font-semibold text-white tracking-wide" style={{ fontFamily: '"Playfair Display", serif' }}>{guestName}</p>
                </motion.div>
              )}
              ...
              <motion.button
                ...
                onClick={handleOpen}
                className="group flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#df9f28] to-[#b45309] hover:from-[#f59e0b] hover:to-[#d97706] text-white rounded-full font-medium tracking-widest text-xs uppercase shadow-[0_0_25px_rgba(223,159,40,0.3)] hover:shadow-[0_0_35px_rgba(223,159,40,0.5)] transition-all duration-500 transform hover:scale-105 cursor-pointer border border-[#df9f28]/40"
              >
        ...
        <SmoothScrollLayout>
          ...
          <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center px-4 max-w-3xl mx-auto flex flex-col items-center">
              ...
              >
                <span className="tracking-[0.4em] text-[#df9f28] uppercase text-xs md:text-sm mb-4 font-bold flex items-center gap-2">
                ...
                {/* Double line divider */}
                <div className="w-24 h-[1px] bg-gradient-to-r from-transparent via-[#df9f28] to-transparent mb-8" />

                <h2 className="text-6xl md:text-8xl font-normal text-white mb-6 drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)] leading-tight tracking-wider" style={{ fontFamily: '"Playfair Display", serif' }}>
                  {brideName} <br />
                  <span className="text-[#df9f28] italic font-light font-serif text-4xl md:text-6xl my-2 block">&amp;</span>
                  {groomName}
                </h2>

                <p className="text-[#d5c2b0] font-serif italic text-lg md:text-xl tracking-widest mt-6 drop-shadow-md">
                  {format(weddingDate, 'EEEE, d MMMM yyyy', { locale: currentLocale })}
                </p>
                ...
                <motion.div 
                  ...
                  className="mt-24 text-[#df9f28]/70 flex flex-col items-center gap-2 cursor-pointer"
                  onClick={() => document.getElementById('verse')?.scrollIntoView({ behavior: 'smooth' })}
                >
                  <span className="text-[10px] tracking-[0.3em] uppercase font-semibold text-[#d5c2b0]/50">Scroll Down</span>
          ...
          <section id="verse" className="py-24 px-6 relative bg-gradient-to-b from-[#120804] to-[#1e0f08]">
            <div className="max-w-3xl mx-auto text-center relative z-10">
              
              {/* Decorative Top Leaf Vector Silhouette */}
              <div className="flex justify-center mb-8 text-[#df9f28]/40">
              ...
              <motion.div 
                ...
                className="bg-[#2d1b10]/40 border border-[#df9f28]/20 rounded-3xl p-8 md:p-14 backdrop-blur-sm relative"
              >
                {/* Corner Ornaments */}
                <div className="absolute top-3 left-3 w-4 h-4 border-t border-l border-[#df9f28]/40" />
                <div className="absolute top-3 right-3 w-4 h-4 border-t border-r border-[#df9f28]/40" />
                <div className="absolute bottom-3 left-3 w-4 h-4 border-b border-l border-[#df9f28]/40" />
                <div className="absolute bottom-3 right-3 w-4 h-4 border-b border-r border-[#df9f28]/40" />
                ...
                {lang === 'id' ? (
                  <>
                    ...
                    <p className="text-[#d5c2b0] text-sm md:text-base leading-relaxed mb-6 font-light">
                    ...
                    <span className="text-xs uppercase tracking-widest text-[#df9f28] font-semibold font-serif">QS. Ar-Rum: 21</span>
                  </>
                ) : (
                  <>
                    <p className="text-xl md:text-2xl text-[#faf6f0] leading-relaxed italic mb-8 font-light" style={{ fontFamily: '"Playfair Display", serif' }}>
                    ...
                    <span className="text-xs uppercase tracking-widest text-[#df9f28] font-semibold font-serif">A. R. & S. K.</span>
                  </>
                )}
              </motion.div>
            </div>
          ...
          <section className="py-24 px-6 relative bg-gradient-to-b from-[#1e0f08] to-[#120804] overflow-hidden">
            
            {/* Background vector glow */}
            <div className="absolute bottom-0 left-0 w-80 h-80 bg-[#df9f28]/5 rounded-full blur-[100px] pointer-events-none" />
            <div className="absolute top-0 right-0 w-80 h-80 bg-[#b45309]/5 rounded-full blur-[100px] pointer-events-none" />

            <div className="max-w-5xl mx-auto relative z-10">
              
              <div className="text-center mb-20">
                <span className="text-[#df9f28] tracking-[0.3em] uppercase text-xs font-bold block mb-3">Mempelai Pernikahan</span>
                <h3 className="text-4xl md:text-5xl text-white font-normal leading-tight font-serif" style={{ fontFamily: '"Playfair Display", serif' }}>
                  The Bride &amp; The Groom
                </h3>
                <div className="w-16 h-[1px] bg-[#df9f28]/40 mx-auto mt-6" />
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-16 md:gap-10 lg:gap-20 items-stretch">
                ...
                <motion.div 
                  ...
                  viewport={{ once: true, margin: "-100px" }}
                  transition={{ duration: 1.2 }}
                  className="flex flex-col items-center text-center p-6 bg-[#2d1b10]/20 border border-[#df9f28]/10 rounded-[3rem] backdrop-blur-xs relative overflow-hidden"
                >
                  ...
                  <p className="text-[#df9f28] text-xs font-semibold uppercase tracking-widest mb-4">
                    {t.brideTitle}
                  </p>
                  
                  <div className="w-12 h-[1px] bg-[#df9f28]/25 mb-4" />
                  
                  <p className="text-[#d5c2b0]/80 text-sm max-w-xs leading-relaxed">
                    {t.daughterOf}<br />
                    <span className="text-white font-semibold block mt-1">{brideParents}</span>
                  </p>

                  {/* Aesthetic social tag */}
                  <a href="https://instagram.com" target="_blank" rel="noreferrer" className="mt-8 text-xs text-[#df9f28]/60 hover:text-[#df9f28] transition-colors border border-[#df9f28]/20 hover:border-[#df9f28]/60 px-4 py-1.5 rounded-full font-mono flex items-center gap-1.5">
              ...
              >
                ...
                <div className="grid grid-cols-4 gap-3 md:gap-6 max-w-2xl mx-auto">
                  {[
                    ...
                    <div key={idx} className="flex flex-col items-center">
                      <div className="w-16 h-18 md:w-24 md:h-24 bg-[#3d2417]/80 border border-[#df9f28]/30 rounded-2xl flex flex-col items-center justify-center shadow-2xl backdrop-blur-md">
                        <span className="text-2xl md:text-4xl font-normal text-white" style={{ fontFamily: '"Playfair Display", serif' }}>{item.value}</span>
                      </div>
                      <span className="text-[10px] md:text-xs uppercase tracking-wider text-[#d5c2b0] mt-3 font-semibold">{item.label}</span>
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-12">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 px-6 py-3 border border-[#df9f28]/40 hover:border-[#df9f28] bg-[#2d1b10]/40 text-[#df9f28] hover:text-white rounded-full text-xs font-semibold tracking-wider uppercase transition-all duration-300 backdrop-blur-md cursor-pointer hover:bg-[#df9f28]/10"
                  >
                    <Calendar size={14} />
          ...
          {/* 5. EVENT DETAILS */}
          <section className="py-24 px-6 relative bg-gradient-to-b from-[#120804] to-[#1e0f08]">
            <div className="max-w-5xl mx-auto">
              
              <div className="text-center mb-20">
                <span className="text-[#df9f28] tracking-[0.3em] uppercase text-xs font-bold block mb-3">Agenda Spesial</span>
                <h3 className="text-4xl md:text-5xl text-white font-normal leading-tight font-serif" style={{ fontFamily: '"Playfair Display", serif' }}>
                  Wedding Events
                </h3>
                <div className="w-16 h-[1px] bg-[#df9f28]/40 mx-auto mt-6" />
              ...
              <div className="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-4xl mx-auto">
                ...
                <motion.div
                  ...
                  className="bg-[#2d1b10]/30 rounded-[2.5rem] p-8 md:p-10 border border-[#df9f28]/15 relative overflow-hidden group hover:border-[#df9f28]/30 hover:bg-[#2d1b10]/40 transition-all duration-500 shadow-xl"
                >
                  <div className="absolute top-0 right-0 w-32 h-32 bg-[#df9f28]/5 rounded-bl-full -mr-16 -mt-16 transition-transform duration-500 group-hover:scale-110" />
                  <div className="relative z-10 text-center">
                    
                    <div className="w-14 h-14 bg-[#3d2417] text-[#df9f28] border border-[#df9f28]/25 rounded-2xl flex items-center justify-center mx-auto mb-6">
                      <Heart size={24} className="fill-current text-[#df9f28]" />
                    </div>
                    ...
                    <p className="text-[#df9f28] font-bold text-sm tracking-wider uppercase mb-8">
                      {format(parseISO(dateStr), 'EEEE, d MMMM yyyy', { locale: currentLocale })}
                    </p>

                    <div className="space-y-4 text-sm text-[#d5c2b0]/90 mb-8 font-light">
                      <div className="flex items-center justify-center gap-3">
                        <Clock size={16} className="text-[#df9f28]/70" />
                        <span>{format(parseISO(dateStr), 'HH:mm')} WIB - Selesai</span>
                      </div>
                      <div className="flex items-center justify-center gap-3">
                        <MapPin size={16} className="text-[#df9f28]/70 shrink-0" />
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noreferrer" 
                      className="inline-flex items-center gap-2 px-6 py-3 bg-[#3d2417] text-[#df9f28] border border-[#df9f28]/30 hover:bg-[#df9f28] hover:text-white rounded-xl text-xs font-bold tracking-wider uppercase transition-colors duration-300 cursor-pointer"
                    >
                      <MapPin size={14} />
                      <span>{t.viewMap}</span>
                    </a>
                ...
                >
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noreferrer" 
                      className="inline-flex items-center gap-2 px-6 py-3 bg-[#df9f28] text-white hover:bg-[#b45309] rounded-xl text-xs font-bold tracking-wider uppercase transition-colors duration-300 shadow-lg cursor-pointer"
                    >
                      <MapPin size={14} />
                      <span>{t.viewMap}</span>
                    </a>
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                transition={{ duration: 1 }}
                className="mt-16 bg-[#2d1b10]/20 p-2 rounded-3xl border border-[#df9f28]/15 overflow-hidden max-w-4xl mx-auto shadow-2xl"
              >
                <iframe
          ...
          <section className="py-24 px-6 relative bg-gradient-to-b from-[#1e0f08] to-[#120804]">
            <div className="max-w-3xl mx-auto">
              
              <div className="text-center mb-20">
                <span className="text-[#df9f28] tracking-[0.3em] uppercase text-xs font-bold block mb-3">Perjalanan Cinta</span>
                <h3 className="text-4xl md:text-5xl text-white font-normal leading-tight font-serif" style={{ fontFamily: '"Playfair Display", serif' }}>
                  {t.journey}
                </h3>
                <div className="w-16 h-[1px] bg-[#df9f28]/40 mx-auto mt-6" />
              ...
              {/* Vertical Timeline */}
              <div className="space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-[#df9f28]/20">
                {[
                  ...
                  >
                    {/* Pulsing Dot Marker */}
                    <div className="flex items-center justify-center w-10 h-10 rounded-full border-2 border-[#df9f28] bg-[#120804] text-[#df9f28] shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10">
                      <Heart size={12} className="fill-current text-[#df9f28]" />
                    </div>

                    {/* Timeline Card */}
                    <div className="w-[calc(100%-3.5rem)] md:w-[calc(50%-2.5rem)] bg-[#2d1b10]/40 p-6 rounded-3xl border border-[#df9f28]/15 shadow-lg group-hover:border-[#df9f28]/40 transition-colors duration-300">
                      <span className="font-serif text-[#df9f28] text-sm font-semibold tracking-wider">{item.year}</span>
                      <h4 className="text-lg font-bold text-white mt-1 mb-2 font-serif" style={{ fontFamily: '"Playfair Display", serif' }}>{item.title}</h4>
                      <p className="text-[#d5c2b0]/90 text-sm leading-relaxed font-light">{item.desc}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
          ...
          {/* 7. PHOTO GALLERY */}
          <section className="py-24 px-6 bg-gradient-to-b from-[#120804] to-[#1a0f0a] relative">
            <div className="max-w-6xl mx-auto">
              
              <div className="text-center mb-16">
                <Camera size={30} className="mx-auto text-[#df9f28]/60 mb-4 animate-pulse" />
                <h3 className="text-4xl md:text-5xl text-white font-normal leading-tight font-serif" style={{ fontFamily: '"Playfair Display", serif' }}>
                  {t.gallery}
                </h3>
                <div className="w-16 h-[1px] bg-[#df9f28]/40 mx-auto mt-6" />
          ...
          {/* 8. RSVP & WISHES FORM */}
          <section className="py-24 px-6 relative bg-gradient-to-b from-[#1a0f0a] to-[#120804]">
            <div className="max-w-2xl mx-auto">
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                transition={{ duration: 1.2 }}
                className="bg-[#2d1b10]/40 border border-[#df9f28]/15 rounded-[2.5rem] p-8 md:p-14 backdrop-blur-md relative shadow-2xl"
              >
                {/* Custom top bubble decorative icon */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-[#3d2417] border border-[#df9f28]/30 rounded-full flex items-center justify-center shadow-lg">
                  <MessageSquare size={20} className="text-[#df9f28]" />
                </div>
                ...
                <div className="text-center mt-6 mb-12">
                  ...
                  <p className="text-[#d5c2b0]/70 text-sm font-light">
                    {t.rsvpSubtitle}
                  </p>
                </div>
                ...
                <AnimatePresence mode="wait">
                  {!isRsvpSubmitted ? (
                    ...
                    >
                      ...
                      <div>
                        <input
                          ...
                          className="w-full px-5 py-4 bg-[#1e0f08]/60 border border-[#df9f28]/20 rounded-2xl text-white placeholder-[#d5c2b0]/40 focus:outline-none focus:ring-1 focus:ring-[#df9f28] focus:border-[#df9f28] transition-all text-sm font-light"
                        />
                      </div>
                      ...
                      <div>
                        <select
                          ...
                          className="w-full px-5 py-4 bg-[#1e0f08]/60 border border-[#df9f28]/20 rounded-2xl text-[#d5c2b0] focus:outline-none focus:ring-1 focus:ring-[#df9f28] focus:border-[#df9f28] transition-all text-sm font-light appearance-none cursor-pointer"
                        >
                          <option value="" className="bg-[#120804]">{t.willAttend}</option>
                          <option value="yes" className="bg-[#120804]">{t.attending}</option>
                          <option value="no" className="bg-[#120804]">{t.notAttending}</option>
                        </select>
                      </div>
                      ...
                      {rsvpForm.attendance === 'yes' && (
                        <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }}>
                          <select
                            ...
                            className="w-full px-5 py-4 bg-[#1e0f08]/60 border border-[#df9f28]/20 rounded-2xl text-[#d5c2b0] focus:outline-none focus:ring-1 focus:ring-[#df9f28] focus:border-[#df9f28] transition-all text-sm font-light appearance-none cursor-pointer"
                          >
                            <option value="1" className="bg-[#120804]">1 {lang === 'en' ? 'Guest' : 'Tamu'}</option>
                            <option value="2" className="bg-[#120804]">2 {lang === 'en' ? 'Guests' : 'Tamu (Maksimal)'}</option>
                          </select>
                        </motion.div>
                      )}
                      ...
                      <div>
                        <textarea
                          ...
                          className="w-full px-5 py-4 bg-[#1e0f08]/60 border border-[#df9f28]/20 rounded-2xl text-white placeholder-[#d5c2b0]/40 focus:outline-none focus:ring-1 focus:ring-[#df9f28] focus:border-[#df9f28] transition-all resize-none text-sm font-light"
                        ></textarea>
                      </div>

                      <button 
                        type="submit" 
                        className="w-full py-4 bg-gradient-to-r from-[#df9f28] to-[#b45309] hover:from-[#f59e0b] hover:to-[#d97706] text-white rounded-2xl font-bold tracking-widest text-xs uppercase shadow-lg transition-all transform hover:scale-[1.01] flex justify-center items-center gap-2 cursor-pointer border border-[#df9f28]/35"
                      >
                        <Send size={14} />
                    ...
                    >
                      <div className="w-16 h-16 bg-[#3d2417] text-[#df9f28] border border-[#df9f28]/30 rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl">
                        <Heart size={30} className="fill-current text-[#df9f28] animate-pulse" />
                      </div>
                      <h4 className="text-2xl font-serif text-white mb-2" style={{ fontFamily: '"Playfair Display", serif' }}>Thank You!</h4>
                      <p className="text-[#d5c2b0]/80 text-sm font-light mb-8 max-w-sm mx-auto">
                      ...
                      <button 
                        ...
                        className="text-xs text-[#df9f28] hover:text-[#f59e0b] border-b border-[#df9f28] pb-0.5 tracking-wider font-semibold cursor-pointer uppercase"
                      >
              ...
              <div className="mt-20 space-y-6">
                <span className="text-center text-[10px] tracking-[0.3em] uppercase text-[#df9f28] block mb-8 font-bold">Buku Tamu Bahagia</span>
                
                <div className="space-y-4 max-h-[420px] overflow-y-auto pr-3 scrollbar-thin scrollbar-thumb-[#df9f28]/25 hover:scrollbar-thumb-[#df9f28]/45">
                  {comments.map((comment) => (
                    <motion.div 
                      ...
                      whileInView={{ opacity: 1, y: 0 }}
                      viewport={{ once: true }}
                      className="bg-[#2d1b10]/20 border border-[#df9f28]/10 rounded-2xl p-6 shadow-sm hover:border-[#df9f28]/20 transition-all"
                    >
                      <div className="flex justify-between items-center mb-3">
                        <p className="font-semibold text-[#df9f28] text-sm tracking-wide" style={{ fontFamily: '"Playfair Display", serif' }}>{comment.name}</p>
                        <span className="text-[10px] text-[#d5c2b0]/45 font-mono">{comment.date}</span>
                      </div>
                      <p className="text-[#faf6f0]/95 font-light text-sm leading-relaxed">{comment.message}</p>
                    </motion.div>
                  ))}
                </div>
              </div>
          ...
          <section className="py-24 px-6 relative bg-gradient-to-b from-[#120804] to-[#1a0f0a] border-t border-[#df9f28]/10">
            <div className="max-w-3xl mx-auto text-center relative z-10">
              ...
              <motion.div
                ...
                transition={{ duration: 1.2 }}
              >
                <div className="w-14 h-14 bg-[#3d2417] text-[#df9f28] border border-[#df9f28]/35 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                  <Gift size={22} />
                </div>
                ...
                <div className="w-16 h-[1px] bg-[#df9f28]/40 mx-auto mt-6 mb-8" />

                <p className="text-[#d5c2b0]/90 text-sm md:text-base leading-relaxed mb-12 max-w-xl mx-auto font-light">
                  {t.giftIntro}
                </p>
                ...
                <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto items-stretch">
                  ...
                  {/* Account 1 */}
                  <div className="bg-[#2d1b10]/30 border border-[#df9f28]/15 rounded-[2rem] p-8 text-left relative overflow-hidden flex flex-col justify-between shadow-xl">
                    <div className="absolute top-0 right-0 p-4 opacity-[0.03] text-white">
                      <CreditCard size={96} />
                    </div>
                    <div>
                      <span className="text-[#df9f28] text-xs font-bold uppercase tracking-wider block mb-1">{data?.bank_name_1 || "Bank BCA"}</span>
                      <p className="text-2xl font-normal font-mono text-white tracking-widest my-2 select-all">{data?.bank_account_1 || "1790 852 462"}</p>
                      <p className="text-[#faf6f0]/75 text-xs uppercase tracking-wide">A.N {data?.bank_account_name_1 || groomName}</p>
                    </div>
                    ...
                    <button
                      ...
                      className={`mt-8 px-5 py-3 rounded-xl text-xs font-bold tracking-widest uppercase w-full transition-all border flex items-center justify-center gap-2 cursor-pointer
                        ${copiedBankIndex === 1 
                          ...
                          : 'bg-[#3d2417] hover:bg-[#df9f28] border-[#df9f28]/25 hover:border-transparent text-[#df9f28] hover:text-white'
                        }`}
                    >
                      {copiedBankIndex === 1 ? (
                        <>
                  ...
                  <div className="bg-[#2d1b10]/30 border border-[#df9f28]/15 rounded-[2rem] p-8 text-left relative overflow-hidden flex flex-col justify-between shadow-xl">
                    ...
                    <div>
                      <span className="text-[#df9f28] text-xs font-bold uppercase tracking-wider block mb-1">{data?.bank_name_2 || "Bank Mandiri"}</span>
                      ...
                      <p className="text-[#faf6f0]/75 text-xs uppercase tracking-wide">A.N {data?.bank_account_name_2 || brideName}</p>
                    </div>
                ...
                <div className="mt-12 bg-[#2d1b10]/20 border border-[#df9f28]/10 rounded-[2rem] p-8 max-w-xl mx-auto">
                  <div className="flex items-center justify-center gap-2 text-[#df9f28] mb-3">
                    <MapPin size={18} />
                    <span className="text-sm font-semibold uppercase tracking-wider">{t.giftAddress}</span>
                  </div>
                  <p className="text-[#faf6f0] text-sm font-light leading-relaxed mb-4">
                  ...
                  <button
                    ...
                    className="text-xs text-[#df9f28] hover:text-[#f59e0b] border-b border-[#df9f28]/40 hover:border-[#df9f28] pb-0.5 tracking-widest font-semibold cursor-pointer uppercase inline-flex items-center gap-1.5"
                  >
          ...
          <footer className="py-20 bg-[#120804] text-center text-[#d5c2b0]/55 border-t border-[#df9f28]/10 relative overflow-hidden">
            ...
            >
              <h2 className="text-3xl md:text-4xl text-white font-normal mb-4 font-serif italic" style={{ fontFamily: '"Playfair Display", serif' }}>
                {t.signature}
              </h2>
              ...
              <div className="w-16 h-[1px] bg-[#df9f28]/25 mx-auto mb-8" />
              
              <p className="text-[10px] tracking-[0.25em] uppercase text-[#df9f28]/70">
