...
export default function CinematicAutumnRustic_10({ data, guestName, lang = 'id' }: any) {
  ...
  const coverImage = data?.cover_image || "https://images.unsplash.com/photo-1532712938310-34cb3982ef74?q=60&w=600";
  const heroImage = data?.hero_image || "https://images.unsplash.com/photo-1532712938310-34cb3982ef74?q=60&w=600";
  ...
  // Configuration for CinematicAutumnRustic_ theme
  const colors = { primary: '#92400E', background: '#FEF3C7', text: '#78350F' };
  const fonts = { heading: "'Playfair Display', serif", body: "'Lora', serif" };
  ...
  return (
    <div className="bg-amber-50 text-amber-900 py-10 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
        ...
        {!isOpen && (
          ...
          >
            ...
            <div className="relative z-10 max-w-xl mx-auto flex flex-col items-center justify-center h-full pt-10">
              ...
              <motion.button
                onClick={handleOpen}
                className="hover:-translate-y-1 px-8 py-4 rounded-full font-medium tracking-widest text-xs uppercase shadow-xl transition-all duration-500 flex items-center gap-3 border"
