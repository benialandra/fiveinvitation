...
export default function CinematicAutumnRustic_10({ data, lang = 'id' }: any) {
  return (
    <div className="bg-[#2c1810] text-[#fff1e6] font-serif min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
      ...
      <div className="py-24 space-y-32">
        <Countdown 
          data={data} 
          lang={lang} 
          className="text-[#ea580c] drop-shadow-lg" 
        />
