...
export default function CinematicAutumnRustic_11({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen relative py-11 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
