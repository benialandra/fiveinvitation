...
export default function CinematicAutumnRustic_7({ data, lang = 'id' }: any) {
  return (
    <div className="bg-[#2d1b10] text-[#faf6f0] font-serif min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
      ...
      <div className="py-24 space-y-32">
        <Countdown 
          data={data} 
          lang={lang} 
          className="text-[#df9f28] drop-shadow-lg" 
        />
