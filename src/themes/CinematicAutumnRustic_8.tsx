...
export default function CinematicAutumnRustic_8({ data, lang = 'id' }: any) {
  return (
    <div className="bg-white text-black font-sans min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
      ...
      <div className="py-24 space-y-32">
        <Countdown 
          data={data} 
          lang={lang} 
          className="text-neutral-500 drop-shadow-lg" 
        />
