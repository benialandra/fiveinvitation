...
export default function CinematicForestMint_10({ data, lang = 'id' }: any) {
  return (
    <div className="bg-[#e0f2ed] text-[#1a3832] font-sans min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
      ...
      <div className="py-24 space-y-32">
        <Countdown 
          data={data} 
          lang={lang} 
          className="text-[#277861] drop-shadow-lg" 
        />
