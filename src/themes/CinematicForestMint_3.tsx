...
export default function CinematicForestMint_3({ data, lang = 'id' }: any) {
  return (
    <div className="bg-[#d3dfd8] text-neutral-900 font-serif min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
      ...
      <div className="py-24 space-y-32">
        <Countdown 
          data={data} 
          lang={lang} 
          className="text-emerald-800 drop-shadow-lg" 
        />
