...
export default function CinematicForestMint_4({ data, lang = 'id' }: any) {
  return (
    <div className="bg-teal-950 text-teal-50 font-sans min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
