...
export default function CinematicForestMint_5({ data, lang = 'id' }: any) {
  return (
    <div className="bg-[#ebfbf3] text-slate-800 font-sans min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
