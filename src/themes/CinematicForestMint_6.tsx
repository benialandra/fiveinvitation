...
export default function CinematicForestMint_6({ data, lang = 'id' }: any) {
  return (
    <div className="bg-[#102a20] text-slate-200 font-serif min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
