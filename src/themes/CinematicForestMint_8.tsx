...
export default function CinematicForestMint_8({ data, lang = 'id' }: any) {
  return (
    <div className="bg-[#404c40] text-[#e6f0e6] font-serif min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
      ...
      <div className="py-24 space-y-32">
        <Countdown 
          data={data} 
          lang={lang} 
          className="text-[#a1d99b] drop-shadow-lg" 
        />
