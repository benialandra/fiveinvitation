...
export default function CinematicForestMint_9({ data, lang = 'id' }: any) {
  return (
    <div className="bg-[#002f23] text-emerald-50 font-serif min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
