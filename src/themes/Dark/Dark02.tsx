...
export default function Dark02({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen py-14 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
