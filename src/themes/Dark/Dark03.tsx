...
export default function Dark03({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="overflow-x-hidden w-full py-15 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
