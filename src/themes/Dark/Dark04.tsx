...
export default function Dark04({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="bg-zinc-950 text-zinc-50 py-16 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
