...
export default function CinematicForestMint_11({ data, lang = 'id' }: any) {
  return (
    <div className="bg-[#00170a] text-[#dcfce7] font-serif min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
      ...
      <div className="py-24 space-y-32">
        <Countdown 
          data={data} 
          lang={lang} 
          className="text-[#22c55e] drop-shadow-lg" 
        />
