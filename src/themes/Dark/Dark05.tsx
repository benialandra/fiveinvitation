...
export default function Dark05({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen py-17 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
