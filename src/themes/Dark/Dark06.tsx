...
export default function Dark06({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="overflow-x-hidden w-full py-18 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
