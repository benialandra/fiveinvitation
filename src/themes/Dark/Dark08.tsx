...
export default function Dark08({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen py-10 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
