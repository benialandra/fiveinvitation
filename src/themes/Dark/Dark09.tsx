...
export default function Dark09({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="overflow-x-hidden w-full py-11 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
