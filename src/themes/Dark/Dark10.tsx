...
export default function Dark10({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="bg-zinc-950 text-zinc-50 py-12 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
