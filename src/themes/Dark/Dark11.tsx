...
export default function Dark11({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen py-13 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
