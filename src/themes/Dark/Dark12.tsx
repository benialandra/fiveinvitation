...
export default function Dark12({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="overflow-x-hidden w-full py-14 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
