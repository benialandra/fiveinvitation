...
export default function Dark13({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="bg-zinc-950 text-zinc-50 py-15 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
