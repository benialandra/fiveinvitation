...
export default function CinematicAutumnRustic_6({ data, lang = 'id' }: any) {
  return (
    <div className="bg-black text-white font-serif min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
