...
export default function Dark14({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen py-16 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
