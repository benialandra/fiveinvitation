...
export default function Dark15({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="overflow-x-hidden w-full py-17 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
