...
export default function Dark16({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="bg-zinc-950 text-zinc-50 py-18 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
