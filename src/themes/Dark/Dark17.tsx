...
export default function Dark17({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen py-19 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
