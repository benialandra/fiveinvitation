...
export default function Dark18({ data, guestName, lang = 'id' }: any) {
  ...
  const coverImage = data?.cover_image || "https://images.unsplash.com/photo-1478146896981-b80fe463b330?q=60&w=600";
  const heroImage = data?.hero_image || "https://images.unsplash.com/photo-1478146896981-b80fe463b330?q=60&w=600";
  ...
  return (
    <div className="overflow-x-hidden w-full py-10 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
