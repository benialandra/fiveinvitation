...
export default function Floral01({ data, guestName, lang = 'id' }: any) {
  ...
  const coverImage = data?.cover_image || "https://images.unsplash.com/photo-1511285560929-80b456fea0bc?q=60&w=600";
  const heroImage = data?.hero_image || "https://images.unsplash.com/photo-1511285560929-80b456fea0bc?q=60&w=600";
  ...
  return (
    <div className="bg-[#FFF5F6] selection:bg-[#D88C9A]/20 py-11 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
