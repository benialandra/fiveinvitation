...
export default function Floral02({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen relative py-12 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
