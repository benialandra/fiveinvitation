...
export default function Floral03({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="overflow-hidden py-13 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
