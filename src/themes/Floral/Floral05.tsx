...
export default function Floral05({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen relative py-15 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
