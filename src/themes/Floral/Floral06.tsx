...
export default function Floral06({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="overflow-hidden py-16 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
