...
export default function Floral08({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen relative py-18 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
