...
export default function Floral09({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="overflow-hidden py-19 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
