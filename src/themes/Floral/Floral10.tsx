...
export default function Floral10({ data, guestName, lang = 'id' }: any) {
  ...
  // Configuration for Floral theme
  const colors = { primary: '#D88C9A', background: '#FFF5F6', text: '#4A3B3D' };
  const fonts = { heading: "'Great Vibes', cursive", body: "'Lora', serif" };
  ...
  return (
    <div className="bg-[#FFF5F6] selection:bg-[#D88C9A]/20 py-10 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
        ...
        {!isOpen && (
          ...
          >
            ...
            <div className="relative z-10 max-w-xl mx-auto flex flex-col items-center justify-center h-full pt-10">
              ...
              <motion.button
                onClick={handleOpen}
                className="hover:scale-110 px-8 py-4 rounded-full font-medium tracking-widest text-xs uppercase shadow-xl transition-all duration-500 flex items-center gap-3 border"
