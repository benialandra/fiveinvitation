...
export default function Floral12({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="overflow-hidden py-12 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
