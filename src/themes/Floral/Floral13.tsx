...
export default function Floral13({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="bg-[#FFF5F6] selection:bg-[#D88C9A]/20 py-13 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
