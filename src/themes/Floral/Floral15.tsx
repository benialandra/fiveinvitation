...
export default function Floral15({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="overflow-hidden py-15 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
