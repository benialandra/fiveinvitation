...
export default function Floral16({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="bg-[#FFF5F6] selection:bg-[#D88C9A]/20 py-16 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
