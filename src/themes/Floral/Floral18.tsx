...
export default function Floral18({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="overflow-hidden py-18 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
