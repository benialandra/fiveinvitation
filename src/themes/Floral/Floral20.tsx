...
export default function CinematicAutumnRustic_5({ data, lang = 'id' }: any) {
  return (
    <div className="bg-neutral-50 text-neutral-900 font-sans min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
      ...
      <div className="py-24 space-y-32">
        <Countdown 
          data={data} 
          lang={lang} 
          className="text-cyan-700 drop-shadow-lg" 
        />
