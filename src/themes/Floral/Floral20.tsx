...
export default function Floral20({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen relative py-10 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
