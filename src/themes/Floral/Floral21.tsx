...
export default function Floral21({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="overflow-hidden py-11 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
