...
export default function CinematicAutumnRustic_4({ data, lang = 'id' }: any) {
  return (
    <div className="bg-slate-900 text-slate-100 font-serif min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
      ...
      <div className="py-24 space-y-32">
        <Countdown 
          data={data} 
          lang={lang} 
          className="text-fuchsia-400 drop-shadow-lg" 
        />
