...
export default function CinematicAutumnRustic_2({ data, lang = 'id' }: any) {
  return (
    <div className="bg-stone-900 text-stone-100 font-serif min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
