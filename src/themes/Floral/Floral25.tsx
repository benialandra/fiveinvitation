...
export default function FloralBlossom({ data, guestName, lang = 'id' }: ThemeProps) {
  ...
  const coverImg = data.cover_image || "https://images.unsplash.com/photo-1519741497674-611481863552?q=60&w=1200&auto=format&fit=crop&fm=webp&q=60";
  const heroImg = data.hero_image || "https://images.unsplash.com/photo-1511285560929-80b456fea0bc?q=60&w=1200&auto=format&fit=crop&fm=webp&q=60";
  ...
  const brideImg = data.bride_image || data.gallery_2 || "https://images.unsplash.com/photo-1520854221256-17451cc331bf?q=60&w=800&auto=format&fit=crop&fm=webp&q=60";
  ...
  const gallery2 = data.gallery_2 || "https://images.unsplash.com/photo-1520854221256-17451cc331bf?q=60&w=800&auto=format&fit=crop&fm=webp&q=60";
