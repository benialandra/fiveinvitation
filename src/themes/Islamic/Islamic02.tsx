...
export default function Islamic02({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="relative w-full py-17 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
