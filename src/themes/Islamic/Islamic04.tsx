...
export default function Islamic04({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen py-19 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
