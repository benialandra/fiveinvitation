...
export default function Islamic06({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="bg-[#F0FDF4] py-11 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
