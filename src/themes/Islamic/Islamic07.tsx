...
export default function Islamic07({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen py-12 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
