...
export default function CinematicForestMint_2({ data, lang = 'id' }: any) {
  return (
    <div className="bg-emerald-950 text-emerald-50 font-serif min-h-screen overflow-x-hidden selection:bg-current selection:text-white">
      <Hero 
        data={data} 
        lang={lang} 
