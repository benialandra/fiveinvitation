...
export default function Islamic08({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="relative w-full py-13 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
