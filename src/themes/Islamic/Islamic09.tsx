...
export default function Islamic09({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="bg-[#F0FDF4] py-14 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
