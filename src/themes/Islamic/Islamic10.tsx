...
export default function Islamic10({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen py-15 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
