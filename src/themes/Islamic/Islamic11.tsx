...
export default function Islamic11({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="relative w-full py-16 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
