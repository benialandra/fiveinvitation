...
export default function Islamic12({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="bg-[#F0FDF4] py-17 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
