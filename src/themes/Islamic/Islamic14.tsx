...
export default function Islamic14({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="relative w-full py-19 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
