...
export default function Islamic15({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="bg-[#F0FDF4] py-10 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
