...
export default function Luxury01({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="w-full py-12 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
