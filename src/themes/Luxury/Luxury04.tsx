...
export default function Luxury04({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="w-full py-15 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
