...
export default function Luxury07({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="w-full py-18 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
