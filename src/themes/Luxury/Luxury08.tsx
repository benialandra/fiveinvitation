...
export default function Luxury08({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="relative overflow-hidden selection:bg-[#D4AF37]/30 py-19 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
