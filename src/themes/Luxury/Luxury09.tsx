...
export default function Luxury09({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="bg-[#0F0F0F] text-[#FFFFFF] py-10 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
