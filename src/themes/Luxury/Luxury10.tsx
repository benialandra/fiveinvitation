...
export default function Luxury10({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="w-full py-11 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
