...
export default function Luxury12({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="bg-[#0F0F0F] text-[#FFFFFF] py-13 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
