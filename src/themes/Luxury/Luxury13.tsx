...
export default function Luxury13({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="w-full py-14 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
