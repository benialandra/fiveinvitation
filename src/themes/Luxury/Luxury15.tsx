...
export default function Luxury15({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="bg-[#0F0F0F] text-[#FFFFFF] py-16 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
