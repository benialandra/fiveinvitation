...
export default function Luxury18({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="bg-[#0F0F0F] text-[#FFFFFF] py-19 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
