...
export default function Luxury19({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="w-full py-10 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
