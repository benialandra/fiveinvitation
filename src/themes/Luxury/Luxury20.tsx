...
export default function Luxury20({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="relative overflow-hidden selection:bg-[#D4AF37]/30 py-11 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
