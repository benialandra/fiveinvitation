...
export default function Luxury21({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="bg-[#0F0F0F] text-[#FFFFFF] py-12 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
