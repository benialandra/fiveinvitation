...
export default function Luxury22({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="w-full py-13 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
