...
export default function Luxury23({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="relative overflow-hidden selection:bg-[#D4AF37]/30 py-14 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
