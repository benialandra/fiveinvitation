...
export default function Luxury25({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="w-full py-16 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
