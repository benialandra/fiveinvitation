...
export default function Luxury26({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="relative overflow-hidden selection:bg-[#D4AF37]/30 py-17 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
