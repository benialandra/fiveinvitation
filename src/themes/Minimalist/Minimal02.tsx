...
export default function Minimal02({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="w-full overflow-x-hidden py-19 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
