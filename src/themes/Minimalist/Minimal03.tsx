...
export default function Minimal03({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="antialiased bg-white text-gray-900 py-10 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
