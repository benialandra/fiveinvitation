...
export default function Minimal04({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen py-11 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
