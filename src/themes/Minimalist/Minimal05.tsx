...
export default function Minimal05({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="w-full overflow-x-hidden py-12 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
