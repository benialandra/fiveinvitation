...
export default function Minimal08({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="w-full overflow-x-hidden py-15 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
