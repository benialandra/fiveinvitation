...
export default function Minimal09({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="antialiased bg-white text-gray-900 py-16 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
