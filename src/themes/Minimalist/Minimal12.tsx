...
export default function Minimal12({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="antialiased bg-white text-gray-900 py-19 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
