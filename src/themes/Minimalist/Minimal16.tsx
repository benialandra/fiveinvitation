...
export default function Minimal16({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="min-h-screen py-13 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
