...
export default function Minimal18({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="antialiased bg-white text-gray-900 py-15 px-5" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
