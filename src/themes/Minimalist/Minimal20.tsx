...
export default function Minimal20({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="w-full overflow-x-hidden py-17 px-7" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
