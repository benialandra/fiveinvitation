...
export default function Minimal21({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="antialiased bg-white text-gray-900 py-18 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
