...
export default function Minimal23({ data, guestName, lang = 'id' }: any) {
  ...
  return (
    <div className="w-full overflow-x-hidden py-10 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
