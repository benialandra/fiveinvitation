...
export default function Rustic01({ data, guestName, lang = 'id' }: any) {
  ...
  // Configuration for Rustic theme
  ...
  return (
    <div className="w-full py-16 px-4" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
