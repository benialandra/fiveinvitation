              ...
              <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 md:gap-32">
                ...
                >
                  <div className="w-56 h-72 md:w-64 md:h-80 mx-auto bg-white p-3 border border-[#8b7355]/20 shadow-xl mb-8 -rotate-2 hover:rotate-0 transition-transform duration-500">
                    <img loading="lazy" src={groomImg} className="w-full h-full object-cover sepia-[0.1]" alt={groom} />
                  </div>
                ...
                >
                  <div className="w-56 h-72 md:w-64 md:h-80 mx-auto bg-white p-3 border border-[#8b7355]/20 shadow-xl mb-8 rotate-2 hover:rotate-0 transition-transform duration-500">
                    <img loading="lazy" src={brideImg} className="w-full h-full object-cover sepia-[0.1]" alt={bride} />
                  </div>
                ...
                {[gallery1, gallery2, gallery3, gallery4].map((img, i) => (
                  ...
                  >
                    <div className="aspect-square w-full">
                      <img loading="lazy" src={img} className="w-full h-full object-cover sepia-[0.2] hover:sepia-0 transition-all duration-700" alt="Gallery" />
                    </div>
                  </motion.div>
                ))}
              </div>
