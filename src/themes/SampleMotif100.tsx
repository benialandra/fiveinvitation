...
export default function SampleMotif100({ data, guestName, lang = 'id' }: ThemeProps) {
  ...
  return (
    <MasterTheme 
      ...
      hero_image={data?.hero_image || "https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?q=80&w=300&auto=format&fit=crop"}
