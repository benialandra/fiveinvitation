...
export default function SampleMotif12({ data, guestName, lang = 'id' }: ThemeProps) {
  ...
  return (
    <MasterTheme 
      ...
      hero_image={data?.hero_image || "https://images.unsplash.com/photo-1532712938310-34cb3982ef74?q=80&w=300&auto=format&fit=crop"}
