...
export default function SampleMotif13({ data, guestName, lang = 'id' }: ThemeProps) {
  ...
  return (
    <MasterTheme 
      ...
      hero_image={data?.hero_image || "https://images.unsplash.com/photo-1520854221256-17451cc331bf?q=80&w=300&auto=format&fit=crop"}
