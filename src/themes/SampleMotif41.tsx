...
export default function SampleMotif41({ data, guestName, lang = 'id' }: ThemeProps) {
  ...
  return (
    <MasterTheme 
      ...
      hero_image={data?.hero_image || "https://images.unsplash.com/photo-1544078754-0a3791001a1c?q=80&w=300&auto=format&fit=crop"}
