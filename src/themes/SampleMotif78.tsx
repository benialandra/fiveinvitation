...
export default function SampleMotif78({ data, guestName, lang = 'id' }: ThemeProps) {
  ...
  return (
    <MasterTheme 
      ...
      hero_image={data?.hero_image || "https://images.unsplash.com/photo-1478146896981-b80fe463b330?q=80&w=300&auto=format&fit=crop"}
