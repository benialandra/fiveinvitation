...
export default function Tropical02({ data, guestName, lang = 'id' }: any) {
  ...
  const coverImage = data?.cover_image || "https://images.unsplash.com/photo-1520854221256-17451cc331bf?q=60&w=600";
  const heroImage = data?.hero_image || "https://images.unsplash.com/photo-1520854221256-17451cc331bf?q=60&w=600";
  ...
  return (
    <div className="min-h-screen py-18 px-6" style={{ fontFamily: fonts.body, backgroundColor: colors.background, color: colors.text }}>
